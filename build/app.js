...
var Globals = /** @class */ (function () {
    ...
    Globals.stageWidth = 1230;
    Globals.stageHeight = 575;
    Globals.contentWidth = 1170;
    Globals.contentHeight = 510;
    Globals.responsive = false;
    Globals.browser = 'undefined';
    Globals.os = 'undefined';
    Globals.isMobile = false;
    Globals.isTouch = false;
    Globals.isTablet = false;
    Globals.product = undefined;
    Globals.lightGrey = 'rgba(204, 204, 204,1)';
    Globals.darkGrey = '#6f6f6f';
    Globals.kawiGreen = '#66cc33';
    Globals.alternate = 'alternate-gothic-no-2-d';
    /* Project specific */
    Globals.slides = [];
    Globals.videos = [];
    return Globals;
...
var deviceCheck_1 = __webpack_require__(5);
var topfeatures_1 = __webpack_require__(9);
var imageLoader_1 = __webpack_require__(26);
window.onload = function () {
    var module;
    var doLoadManifest = false;
    var loader;
    function init() {
    ...
    function parseConfig(data) {
        ...
        $.each(j.videos, function (i, e) {
            globals_1.default.videos.push(e);
        });
        if (j.manifest && j.manifest.length) {
            loader = new imageLoader_1.default();
            globals_1.default.manifest = loader.preload(j.manifest);
...
Object.defineProperty(exports, "__esModule", { value: true });
var detect_browser_1 = __webpack_require__(6);
var DeviceChecker = /** @class */ (function () {
    function DeviceChecker() {
    }
    DeviceChecker.check = function () {
        var userAgent = navigator.userAgent;
        var browser = detect_browser_1.detect();
        var info = { browser: 'undefined', os: 'undefined', isTablet: false, isMobile: false, isTouch: false };
        info.os = browser.os;
...
var slides_1 = __webpack_require__(12);
var videoPlayer_1 = __webpack_require__(23);
var TopFeatures = /** @class */ (function () {
    function TopFeatures() {
        ...
        globals_1.default.openVideo = this.openVideo;
        globals_1.default.closeVideo = this.closeVideo;
        this.nav = new nav_1.default();
        $(this.nav).on('onNavClicked', this.onNavButtonClick);
        this.slides = new slides_1.default();
        this.setTo(1);
        this.video = new videoPlayer_1.default();
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
var navButton_1 = __webpack_require__(11);
var globals_1 = __webpack_require__(0);
...
Object.defineProperty(exports, "__esModule", { value: true });
var globals_1 = __webpack_require__(0);
var slides_1 = __webpack_require__(13);
var gsap_1 = __webpack_require__(21);
var TFSlideManager = /** @class */ (function () {
    function TFSlideManager() {
        ...
        $.each(globals_1.default.slides, function (i, e) {
            ...
            gsap_1.TweenMax.set(slide.element, { x: globals_1.default.contentWidth });
        });
    }
    TFSlideManager.prototype.setSlide = function (index) {
        var slide = this.slides[index];
        gsap_1.TweenMax.set(slide.element, { x: 0 });
        slide.animateIn(0);
        this.currentSlide = slide;
        $.each(this.slides, function (i, s) {
            if (s.index < index) {
                gsap_1.TweenMax.set(s.element, { x: -globals_1.default.contentWidth });
            }
            if (s.index > index) {
                gsap_1.TweenMax.set(s.element, { x: globals_1.default.contentWidth });
            }
    ...
    TFSlideManager.prototype.slideTo = function (index) {
        ...
        if (index > this.currentSlide.index) {
            gsap_1.TweenMax.set(slide.element, { x: globals_1.default.contentWidth });
            gsap_1.TweenMax.to(this.currentSlide.element, 0.4, { overwrite: 'all', x: -globals_1.default.contentWidth, ease: gsap_1.Circ.easeInOut });
        }
        if (index < this.currentSlide.index) {
            gsap_1.TweenMax.set(slide.element, { x: -globals_1.default.contentWidth });
            gsap_1.TweenMax.to(this.currentSlide.element, 0.4, { overwrite: 'all', x: globals_1.default.contentWidth, ease: gsap_1.Circ.easeInOut });
        }
        gsap_1.TweenMax.to(slide.element, 0.4, { overwrite: 'all', x: 0, ease: gsap_1.Circ.easeInOut });
...
Object.defineProperty(exports, "__esModule", { value: true });
var slide1_1 = __webpack_require__(14);
var slide2_1 = __webpack_require__(16);
var topFeatureSlide_1 = __webpack_require__(2);
exports.Slides = {
    Slide1: slide1_1.default,
    Slide2: slide2_1.default,
    TopFeatureSlide: topFeatureSlide_1.default,
};
...
var globals_1 = __webpack_require__(0);
var topFeatureSlide_1 = __webpack_require__(2);
var watchVideoButton_1 = __webpack_require__(15);
var Slide1 = /** @class */ (function (_super) {
    ...
    function Slide1(index, data) {
        ...
        */
        ...
        _this.btn.x = 30;
        _this.btn.y = 410;
        _this.btn.element.on('click', function () {
            globals_1.default.openVideo('video1');
        });
        _this.text.find('span').css({
            lineHeight: '15px'
        });
        return _this;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
var UiElement_1 = __webpack_require__(1);
var WatchVideoButton = /** @class */ (function (_super) {
    __extends(WatchVideoButton, _super);
    function WatchVideoButton(label, color1, color2) {
        ...
        _this.onMouseOver = function () {
            TweenMax.to(_this.textfield, 0.2, { overwrite: 'all', color: _this.color2 });
            TweenMax.to(_this.icon, 0.2, { overwrite: 'all', backgroundColor: _this.color2 });
        };
        _this.onMouseOut = function () {
            TweenMax.to(_this.textfield, 0.1, { overwrite: 'all', color: _this.color1 });
            TweenMax.to(_this.icon, 0.1, { overwrite: 'all', backgroundColor: _this.color1 });
        };
        _this.color1 = color1;
        _this.color2 = color2;
        // this.element = $(document.createElement('div'));
        ...
        _this.textfield = $(document.createElement('div'));
        _this.textfield.addClass('tf-watchVideoButton');
        _this.element.append(_this.textfield);
        _this.textfield.text(label);
        _this.textfield.css({
            color: _this.color1
        });
        _this.icon = $(document.createElement('div'));
        _this.element.append(_this.icon);
        _this.icon.addClass('tf-watchVideoIcon');
        _this.icon.css({
            backgroundColor: _this.color1
        });
        _this.arrow = $(document.createElement('div'));
        _this.icon.append(_this.arrow);
        _this.arrow.addClass('tf-watchVideoArrow');
        _this.element.on('mouseenter', _this.onMouseOver);
        _this.element.on('mouseleave', _this.onMouseOut);
        return _this;
    }
    WatchVideoButton.prototype.animateIn = function (delay) {
        if (delay === void 0) { delay = 0; }
    ...
    WatchVideoButton.prototype.animateOut = function (delay) {
        if (delay === void 0) { delay = 0; }
    };
...
var topFeatureSlide_1 = __webpack_require__(2);
/* slide dependencies */
var baseSubSlide_1 = __webpack_require__(17);
var subSlideNav_1 = __webpack_require__(19);
var Slide2 = /** @class */ (function (_super) {
    __extends(Slide2, _super);
    function Slide2(index, data) {
        var _this = _super.call(this, index, data) || this;
        _this.slideId = 'tf-slide2-';
        _this.slides = [];
        _this.currentIndex = -1;
        _this.onSubNavClick = function (e, data) {
            if (data.index === _this.currentIndex) {
                _this.setSlideTo(-1);
                _this.nav.deselect(data.index);
                _this.currentIndex = -1;
            }
            else {
                _this.setSlideTo(data.index);
                _this.nav.select(data.index);
                _this.currentIndex = data.index;
            }
        };
        _this.element.css({
   ...
   ------------------------------------------------------------------------------------------------------------------------------*/
    Slide2.prototype.createSlides = function () {
        //slide 0
        var slide = this.addSlide({
            element: 'tf-slide2-landing',
            imgSrc: globals_1.default.manifest['bg1'],
            navLabel: 'None',
            textTop: 200,
            textWidth: 420
        });
        ...
        slide = this.addSlide({
            ...
            imgSrc: globals_1.default.manifest['bg2'],
            navLabel: 'Impeller',
            textTop: 200,
            textWidth: 420
        });
        ...
        slide = this.addSlide({
            ...
            imgSrc: globals_1.default.manifest['bg3'],
   ...
   ------------------------------------------------------------------------------------------------------------------------------*/
    Slide2.prototype.createNav = function () {
        this.nav = new subSlideNav_1.default(this.slides);
        ...
        this.nav.x = globals_1.default.contentWidth - 200; // based on longest subnav button label
        this.nav.y = 40;
    };
    /*-----------------------------------------------------------------------------------------------------------------------------
        CORE METHODS
    ------------------------------------------------------------------------------------------------------------------------------*/
    Slide2.prototype.animateIn = function (delay) {
        if (delay === void 0) { delay = 0; }
        _super.prototype.animateIn.call(this, delay);
    };
    Slide2.prototype.animateOut = function (delay) {
        if (delay === void 0) { delay = 0; }
        _super.prototype.animateOut.call(this, delay);
    };
    /*-----------------------------------------------------------------------------------------------------------------------------
    ...
    ------------------------------------------------------------------------------------------------------------------------------*/
    Slide2.prototype.setSlideTo = function (value) {
        var prevSlide = this.slides[this.currentIndex + 1].slide;
        prevSlide.animateOut(0.0);
        var slide = this.slides[value + 1].slide;
        slide.animateIn(0.3);
    };
    Slide2.prototype.addSlide = function (options) {
        var s = new baseSubSlide_1.default(options);
        var obj = {
            slide: s,
            data: options
        };
...
var gsap_1 = __webpack_require__(21);
var globals_1 = __webpack_require__(0);
var BaseSubSlide = /** @class */ (function () {
    function BaseSubSlide(options) {
        ...
        var h1 = this.textContainer.find('h1');
        this.h1 = h1;
        h1.css({
            color: 'white', fontSize: '40px'
        });
        var span = this.textContainer.find('span');
        span.css({
            color: globals_1.default.lightGrey
        });
    }
    BaseSubSlide.prototype.animateIn = function (delay) {
        if (delay === void 0) { delay = 0; }
        this.textContainer.find('*').each(function (i, e) {
            var d = (i * 0.025) + 0.2;
            gsap_1.TweenMax.set(e, { opacity: 0 });
            gsap_1.TweenMax.to(e, 0.85, { opacity: 1, delay: delay + d, ease: gsap_1.Power3.easeOut });
        });
        gsap_1.TweenMax.to(this.element, 0.3, { opacity: 1, delay: delay, ease: gsap_1.Power3.easeOut });
        this.element.show();
    };
    BaseSubSlide.prototype.animateOut = function (delay) {
        var _this = this;
        if (delay === void 0) { delay = 0; }
        gsap_1.TweenMax.to(this.element, 0.25, { opacity: 0, delay: delay, ease: gsap_1.Power3.easeOut, onComplete: function () {
                _this.element.hide();
            } });
    };
    return BaseSubSlide;
}());
exports.default = BaseSubSlide;
...
Object.defineProperty(exports, "__esModule", { value: true });
var UiElement_1 = __webpack_require__(1);
var subSideNavButton_1 = __webpack_require__(20);
var SubSlideNav = /** @class */ (function (_super) {
    __extends(SubSlideNav, _super);
    function SubSlideNav(slides) {
        var _this = _super.call(this) || this;
        _this.rolloutTime = 250;
        _this.state = 'normal';
        _this.onBtnOver = function (e) {
            var index = $(e.currentTarget).data('index');
            var btn = _this.btns[index];
            btn.lighten();
            $.each(_this.btns, function (i, b) {
                if (_this.state === 'normal') {
                    if (b != btn)
                        b.darken();
                }
                if (_this.state === 'on') {
                    if (b != _this.currentBtn && b != btn)
                        b.darken();
                }
            });
            clearTimeout(_this.rolloutTimer);
            // btn.onMouseOver();
        };
        _this.onBtnOut = function (e) {
            _this.rolloutTimer = setTimeout(function () {
                var index = $(e.currentTarget).data('index');
                var btn = _this.btns[index];
                $.each(_this.btns, function (i, b) {
                    if (_this.state === 'normal') {
        ...
        _this.onBtnClick = function (e) {
            var index = $(e.currentTarget).data('index');
            $(_this).trigger('onSubNavClick', { index: index });
        };
        _this.select = function (index) {
            ...
            btn.select();
            _this.state = 'on';
            _this.currentBtn = btn;
        };
        _this.deselect = function (index) {
            var btn = _this.btns[index];
            $.each(_this.btns, function (i, b) {
                b.reset();
            });
            _this.state = 'normal';
            _this.currentBtn = null;
        };
        _this.btns = [];
        _this.element.css({});
        var count = 0;
        $.each(slides, function (i, e) {
            if (i > 0) {
                var s = new subSideNavButton_1.default(count, e.data.navLabel);
                _this.element.append(s.element);
                s.element.on('mouseenter', _this.onBtnOver);
                s.element.on('mouseleave', _this.onBtnOut);
                s.element.on('click', _this.onBtnClick);
                _this.btns.push(s);
                count++;
            }
        });
...
var globals_1 = __webpack_require__(0);
var UiElement_1 = __webpack_require__(1);
var SubSlideSubNavButton = /** @class */ (function (_super) {
    __extends(SubSlideSubNavButton, _super);
    function SubSlideSubNavButton(index, label) {
        var _this = _super.call(this) || this;
        _this.darken = function () {
            TweenMax.to(_this.textfield, 0.2, { overwrite: 'auto', color: '#6f6f6f' });
        };
        _this.lighten = function () {
            TweenMax.to(_this.textfield, 0.2, { overwrite: 'auto', color: '#fff' });
        };
        _this.reset = function () {
            TweenMax.to(_this.textfield, 0.3, { overwrite: 'auto', scale: 1, color: '#fff' });
        };
        _this.deselect = function () {
            TweenMax.to(_this.textfield, 0.3, { overwrite: 'auto', scale: 0.8 });
        };
        _this.select = function () {
            TweenMax.to(_this.textfield, 0.2, { overwrite: 'auto', color: '#fff', scale: 1 });
            _this.element.css({});
        };
        _this.eventsOn = function () {
            _this.element.css({});
        };
        _this.onMouseOver = function () {
        };
        ...
        _this.element.data('index', index);
        _this.index = index;
        _this.textfield = $(document.createElement('div'));
        _this.element.append(_this.textfield);
        _this.element.css({
        ...
        _this.textfield.css({
            position: 'relative',
            fontFamily: globals_1.default.alternate,
        ...
        _this.textfield.addClass('noselect');
        TweenMax.set(_this.textfield, { transformOrigin: '100% 40%' });
        _this.textfield.text(label);
        _this.iconContainer = $(document.createElement('div'));
        _this.iconContainer.css({
            width: 10, height: 10, borderRadius: '50%',
            border: '3px solid ' + globals_1.default.kawiGreen, position: 'absolute',
            top: 1, left: '100%', transform: 'translateX(-100%)'
        });
        _this.element.append(_this.iconContainer);
        return _this;
    }
    return SubSlideSubNavButton;
}(UiElement_1.default));
exports.default = SubSlideSubNavButton;
...
Object.defineProperty(exports, "__esModule", { value: true });
var globals_1 = __webpack_require__(0);
var closeButton_1 = __webpack_require__(24);
var kawiPlayer_1 = __webpack_require__(25);
var TFVideoPlayer = /** @class */ (function () {
    function TFVideoPlayer() {
        var _this = this;
        this.element = $('#tf-videoPlayer');
        this.videos = [];
        $.each(globals_1.default.videos, function (i, e) {
            _this.videos[e.id] = e;
        });
        ...
        this.player = new kawiPlayer_1.default({});
        this.container.append(this.player.element);
        this.btn = new closeButton_1.default();
        this.element.append(this.btn.element);
        this.btn.x = globals_1.default.stageWidth - this.btn.width - 10;
        this.btn.y = 10;
        $(this.btn.element).on('click', this.onCloseDown);
        this.element.hide();
    }
    TFVideoPlayer.prototype.onCloseDown = function () {
        globals_1.default.closeVideo();
    };
    TFVideoPlayer.prototype.open = function (delay) {
        if (delay === void 0) { delay = 0; }
        this.element.show();
    };
    TFVideoPlayer.prototype.close = function (delay) {
        if (delay === void 0) { delay = 0; }
        this.element.hide();
    };
    return TFVideoPlayer;
}());
exports.default = TFVideoPlayer;
...
var CloseButton = /** @class */ (function (_super) {
    ...
    function CloseButton() {
        ...
        _this.line1 = $(document.createElement('div'));
        _this.line2 = $(document.createElement('div'));
        _this.element.css({
            width: 30, height: 30,
            position: 'absolute',
            cursor: 'pointer'
        ...
        _this.element.append(_this.line1);
        _this.line1.css(linestyle);
        TweenMax.set(_this.line1, { rotation: 45 });
        _this.element.append(_this.line2);
        _this.line2.css(linestyle);
        TweenMax.set(_this.line2, { rotation: -45 });
        return _this;
    }
    return CloseButton;
}(UiElement_1.default));
...
var KawiPlayer = /** @class */ (function () {
    ...
    */
    ...
    KawiPlayer.CONTAIN = 'contain';
    KawiPlayer.COVER = 'cover';
    KawiPlayer.FULL = 'full';
    return KawiPlayer;
}());
exports.default = KawiPlayer;
...
var ImageLoader = /** @class */ (function () {
    function ImageLoader() {
        ...
        this.onImageLoaded = function (e) {
            var img = e.target;
            _this.count++;
            _this.progress = _this.count / _this.amount;
    ...
    ImageLoader.prototype.preload = function (manifest) {
